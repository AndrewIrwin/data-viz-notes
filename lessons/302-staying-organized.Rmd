...
As soon as you start work on a new project, you should give some thought to [backups](https://www.worldbackupday.com/en) too. I put project folders in '[Dropbox](https://help.dropbox.com/sync/sync-overview)' or '[OneDrive](https://support.microsoft.com/en-us/office/sync-with-onedrive-bb89981b-e382-4969-b8fd-d413a90b6db3)' and use their automatic synchonization feature to reduce the chance of losing my work.
...
* R for Data Science notes on [scripts](https://r4ds.hadley.nz/workflow-scripts.html) and  [projects](https://r4ds.hadley.nz/workflow-scripts.html)
