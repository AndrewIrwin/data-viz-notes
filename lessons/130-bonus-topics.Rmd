...
### Relabelling factors on plots

Sometimes you want to change the way the name of a factor (or string) label is shown on a plot. Here I will create clusters from the Palmer penguins data and then change the names from 1, 2, 3, to 
"Cluster A", "Cluster B", and "Cluster C". I'll show three different ways to accomplish the same goal.
...
The string and date/time manipulation functions are part of the tidyverse. A full list of tidyverse packages is

```{r}
tidyverse_packages() |> cat(sep = ", ")
```

In addition I have used functions from the following packages
