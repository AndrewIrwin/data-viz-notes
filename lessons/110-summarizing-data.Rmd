...
We will work with the `diamonds` dataset; it's fairly large and has a combination of quantitative and categorical data which can be used to illustrate these methods. R4DS [chapter 5](https://r4ds.had.co.nz/transform.html) does many similar demonstrations with a large database of flight data. You should practice all these calculations on a data set of your choice (some ideas are [here](#data-sources)).
