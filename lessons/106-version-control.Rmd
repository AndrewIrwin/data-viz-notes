...
Note that you can see modification times for all files in your repository on GitHub. You can preview the Quarto file (.qmd) but the rendered file (.html) is shown as HTML code not as a formatted web page. As long as the file has the correct modification time, you can be confident that the version from your computer has been copied to the GitHub server.
...
Type `git` at the terminal to check that the installation worked. If you see some help text displayed instead of an error message you know git is installed.
...
Git is already installed on posit.cloud. There are several ways to confirm this.
...
-   Rstudio [help](https://docs.posit.co/ide/user/ide/guide/tools/version-control.html) for git
-   Software Carpentry [tutorial using git with Rstudio](https://swcarpentry.github.io/git-novice/index.html)
-   [Happy Git with R](https://happygitwithr.com/)
-   [Advanced Git cheat sheet](https://www.maxpou.fr/blog/git-cheat-sheet)
