...
A second approach is to group the rows and columns so that similar patterns are side by side. FIXME find heatmpa function.
...
* `ggheatmap` available on github using `remotes::install_github("tleonardi/ggheatmap")`
