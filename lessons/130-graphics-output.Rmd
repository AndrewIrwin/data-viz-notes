...
The `ragg` library and graphics output device also provides reliable rendering text in many (perhaps most) languages and a way to scale the size of images across different output formats. 

I've copied the nice map with an emoji and Japanese text from [this tutorial](https://www.tidyverse.org/blog/2021/02/modern-text-features/):
