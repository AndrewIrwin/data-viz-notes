...
* `readr` which is part of `tidyverse`
* `readxl` for reading Excel (xls, xlsx) format workbooks and spreadsheets
* `skimr` for giving an overview of data
* `naniar` for summarizing missing data
