...
(You may get a warning message, but you can safely ignore it; [here is an explanation](https://stackoverflow.com/a/56637322).)
...
m6 <- quantreg::rq(logGDP ~ year1950, data= gp,
      # slice_sample(gp, n = 349, replace=TRUE), # no warning message
                   tau = 0.10)
summary(m6)
```
