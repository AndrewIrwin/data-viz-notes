...
You can read these notes as a static document in a web browser, but it's better to create a quarto (or R markdown file) on your computer and type and modify the examples as you read.
