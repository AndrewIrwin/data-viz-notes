...
-   regression and smoothing of one variable as a function of another (lessons 16-18), and
-   transforming, simplification, and grouping of observations in data with many (more than 2) variables (lessons 22-24).
...
-   Healy [Chapter 6 Working with models](https://socviz.co/modeling.html#modeling), [@healy2018data]
