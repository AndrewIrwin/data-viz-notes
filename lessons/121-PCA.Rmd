...
* center the data at the origin by subtracting the mean of each variable,
* usually, but optionally, scale each variable to have the same standard deviation,
* compute the covariance matrix (the correlation matrix if data are scaled),
