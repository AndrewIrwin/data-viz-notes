...
This example requires the R package `reticulate` and a working python interpreter that R can find. The Quarto tools for reproducible reports provide even better support for python.
