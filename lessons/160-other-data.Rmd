...
Incidentally, a similar database structure would work for academic research articles. In the last few years, international standards for author ID numbers ([ORCID](https://en.wikipedia.org/wiki/ORCID)) and publication ID numbers ([DOI](https://www.doi.org/the-identifier/what-is-a-doi/)) have been developed to facilitate this sort of database construction.
