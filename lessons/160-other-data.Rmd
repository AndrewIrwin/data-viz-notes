...
dir.create(here::here("lessons/static/L160"), recursive=TRUE)
...
resources(package)
get_schema(package, "reference-data") # contains: name, title, description, type, format for each variable
...
```{r}
penguins_both_csvw <- read_csvw("static/L160/penguins-csvw-metadata.json")
